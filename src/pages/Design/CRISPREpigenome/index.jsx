...
import CRISPREpigenomeImage from "@/assets/images/design/crispr_epigenome.png";
import {
  InfoCircleOutlined,
...
import { executeCRISPREpigenomeDesign } from "@/utils/api/apis";
import PollingLoader from "@/components/PollingLoader";

const { Option } = Select;
const { TextArea } = Input;

const CRISPREpigenome = () => {
  ...
  return (
    <div className="epigenome-container">
      {contextHolder}
      {/* 轮询加载组件 */}
      <PollingLoader
        ref={pollingLoaderRef}
        apiFunction={executeCRISPREpigenomeDesign}
        resultPath="/crispr-epigenome/result"
      ...
      <div className="epigenome-header">
        ...
        <div className="epigenome-intro">
          ...
          <p>
            The epigenome involves a complex set of cellular processes governing
            genomic activity. Epigenome Editing (EE) enables researchers to
            activate and repress endogenous gene expression and can provide
            graded control over gene regulation. Recruitment of epigenome
          ...
          <ul>
            ...
            <li>histone demethylation</li>
            <li>cytosine methylation</li>
            <li>cytosine demethylation</li>
          </ul>
        </div>
      </div>

      {/* 下部分：表单 */}
      <div className="epigenome-form">
          ...
          <div className="form-submit">
            <div className="submit-container">
              <button type="submit" className="submit-btn">
                Design CRISPR Epigenome sgRNAs 》
              </button>
            </div>
          </div>
        </form>
...
export default CRISPREpigenome;
